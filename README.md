...
**Full results:** [the rendered report](https://poglesbyg.github.io/sepsis-early-warning/) — every figure, every table, and
the interactive replay, in one page that needs no clone and no build. The Markdown
source is [`reports/REPORT.md`](reports/REPORT.md), committed and generated by the
pipeline; the page is rebuilt from it on every push by
...
[rendered report](https://poglesbyg.github.io/sepsis-early-warning/) replays four admissions hour by hour instead —
